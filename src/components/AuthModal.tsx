            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-[10px] opacity-70 block">Book car washes</span>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <span className="text-xs font-bold block">Admin / Ops</span>
                  <span className="text-[10px] opacity-70 block">Manage washes</span>
                </div>
              </button>
            </div>
          </div>
