          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {currentUser ? (
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                <button
                  onClick={onOpenAuth}
                  className="px-3 py-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 font-bold text-xs transition-all cursor-pointer"
                >
                  Sign In
                </button>
                <button
                  onClick={onOpenAuth}
                  className="flex items-center gap-1 px-3 py-1.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-slate-950 font-bold text-xs shadow-md shadow-cyan-500/20 hover:from-cyan-400 hover:to-blue-500 transition-all cursor-pointer"
                >
